...
import LogisticInfo2 from './../components/logisticsInfo2.jsx'
import LogisticsSummary2 from './../components/logisticsSummary2.jsx'
import {HashRouter, Route, Link} from 'react-router-dom';


export default class LogisticsPartner2 extends React.Component
{
        ...
        <Modal size='large' open={this.state.open} onClose={this.close}>
            ...
            <br/>
              ...
              <span>Product Route :</span><br/>
                ...
                <span>7th Jan 2018,Sun  |TimBrothers Logistics| 1ab5cmqmvQq8YTREEqcTmW7dfBNuFfgdCD</span><br/>
                </div>
            </Modal.Content>
            <Modal.Actions>
