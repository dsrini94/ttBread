...
import humidData from './../components/humidData.js';

var duplicateTempData = humidData;
...
export default class TempChart extends React.Component {
  ...
  componentDidMount() {
    ...
    dummy.push(humidData.map((item,i)=>{
      ...
      datasets: [
        {
          ...
          pointBorderWidth: 3,
          pointHoverRadius: 5,
          pointHoverBackgroundColor: '#7ee5a0',
          ...
          <Grid.Column width={12}>
            <Segment style={{
              ...
              <Header style={{
                ...
                <span className="headers" style={{color:'black'}}>Humidity</span>
              </Header>
            </Segment>
          </Grid.Column>
          <Grid.Column width={2}/>
